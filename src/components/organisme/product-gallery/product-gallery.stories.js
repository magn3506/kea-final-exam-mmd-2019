    ...
    edges: [
      {
        node: {
            ...
            img: [
                {
                    resize: {
                        src: "//images.ctfassets.net/yyhkqa4jdoli/59DY9tB1bS1wsP0GV0T47g/70e80032d4319dc1f51dd8ede921aa71/size-s-.jpg?w=300&h=300&fl=progressive&q=50&fit=fill"
                    }
                }
            ],
...
export const productGallery = () => <ProductGallery products={products} />